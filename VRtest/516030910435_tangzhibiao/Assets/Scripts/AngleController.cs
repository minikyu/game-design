...
public class AngleController : MonoBehaviour
{
	...
	[Range(0, 10)] public float maxMovingSpeed = 3.0f;

	[HideInInspector] public float movingSpeed = 0.0f;

	private Vector3 _head_right; private Vector3 _head_right_on_xy; private Vector3 _head_right_on_xz;
